...
ax.text(8, 8.0, '▼  RK reconstruction: blend the slopes to walk back to t = 0.1',
        fontsize=11, ha='center', fontweight='bold', color='#1565C0')

draw_box(0.3, 6.6, 4.8, 0.9,
         'r₁ = û₁ − Δt·(a₁₁·u_t₁ + a₁₂·u_t₂)',
         color='#E3F2FD', border='#1565C0', fontsize=10)
draw_box(5.8, 6.6, 4.8, 0.9,
         'r₂ = û₂ − Δt·(a₂₁·u_t₁ + a₂₂·u_t₂)',
         color='#E3F2FD', border='#1565C0', fontsize=10)
draw_box(11.2, 6.6, 4.3, 0.9,
         'r₃ = û₃ − Δt·(b₁·u_t₁ + b₂·u_t₂)',
         color='#E3F2FD', border='#1565C0', fontsize=10)
...
arrow(11.25, 8.6, 13.35, 7.5, color='#7B1FA2')
...
arrow(2.7, 6.6, 5, 5.5, color='#E65100')
arrow(8.2, 6.6, 8, 5.5, color='#E65100')
arrow(13.35, 6.6, 11, 5.5, color='#E65100')
...
plt.title('R157: Allen-Cahn Discrete PINN — No new symbols!\n'
          'u_t = slope from the PDE  |  r = reconstruction that should match known data',
          fontsize=14, fontweight='bold', pad=20)

plt.tight_layout()
plt.savefig('demos/r157_allen_cahn_clear.png', dpi=150, bbox_inches='tight')
plt.show()
